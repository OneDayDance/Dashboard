...
export const templates = {
    ...
    modals: `
        ...
        <div id="client-details-modal" class="modal"><div class="modal-content large"><div class="modal-header"><h2 id="client-modal-name">Client Details</h2><span class="close-button">&times;</span></div><div class="modal-body two-column"><nav class="modal-nav"><a href="#" class="modal-nav-link active" data-tab="details">Details</a><a href="#" class="modal-nav-link" data-tab="history">History</a><a href="#" class="modal-nav-link" data-tab="notes">Notes & Logs</a><a href="#" class="modal-nav-link" data-tab="financials">Financials</a><a href="#" class="modal-nav-link" data-tab="actions">Actions</a></nav><div class="modal-pane-content"></div></div><div class="modal-footer"><span id="client-modal-status"></span></div></div></div>
        <!-- Add Client Modal -->
